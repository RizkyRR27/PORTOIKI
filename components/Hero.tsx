...
export default function Hero() {
  ...
  <Link 
    href="/project" 
    className="px-8 py-4 bg-red-600 border-2 border-black-700 text-white font-bold rounded-lg transition-all duration-300 transform hover:scale-105 hover:shadow-lg hover:shadow-orange-500/50 active:scale-95 text-center"
  >
    Lihat Projek Saya
  </Link>
  ...
  <Link 
    href="/about" 
    className="px-8 py-4 bg-blue-600 border-2 border-black-500 text-whote font-bold rounded-lg transition-all duration-300 transform hover:scale-105 hover:shadow-lg hover:shadow-yellow-500/50 active:scale-95 text-center"
  >
    Tentang Saya
  </Link>
</div>
